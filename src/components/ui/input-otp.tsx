...
function InputOTPGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40 has-aria-invalid:border-destructive rounded-none has-aria-invalid:ring-1 flex items-center",
        className,
      )}
      {...props}
    />
...
function InputOTPSeparator({ ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useFocusableInteractive: false flag
    // biome-ignore lint/a11y/useSemanticElements: false flag
    <div
      data-slot="input-otp-separator"
      className="[&_svg:not([class*='size-'])]:size-4 flex items-center"
      // biome-ignore lint/a11y/useAriaPropsForRole: false flags
      role="separator"
      aria-hidden="true"
      {...props}
    >
