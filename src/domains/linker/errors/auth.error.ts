import { AUTH_ERROR_CODES, AUTH_ERROR_MESSAGES } from "@/domains/linker/constants/auth.constants";
import type { AuthErrorCode } from "@/domains/linker/types/auth.types";
