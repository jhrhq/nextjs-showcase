...
import type { UrlFieldStatus } from "./types";
 ...
 */
export const ICON_COLOR_MAP: Readonly<Record<UrlFieldStatus, string>> = {
 ...
 */
export const ROW_BORDER_MAP: Readonly<Record<UrlFieldStatus, string>> = {
