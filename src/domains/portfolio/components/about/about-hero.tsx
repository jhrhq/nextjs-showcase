      ...
      <div className="mx-auto max-w-7xl px-5 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-32">
        <div className="max-w-5xl">
          ...
          <h1 className="max-w-4xl text-balance text-4xl font-semibold tracking-[-0.04em] sm:text-6xl lg:text-7xl">
            Frontend developer who enjoys turning complex ideas into simple
            interfaces.
          </h1>

          <div className="mt-8 max-w-3xl space-y-4">
            <p className="text-base leading-8 text-muted-foreground sm:text-lg">
              I&apos;m Johir Haque, a frontend developer with professional
              experience building production SaaS applications. My work has
              primarily centered around React and TypeScript, with a strong
              focus on application architecture, data-driven interfaces, and
              thoughtful user experiences.
            </p>

            <p className="text-sm leading-7 text-muted-foreground sm:text-base">
              My path into web development has been largely self-directed. I
              learn by building, and I&apos;m currently expanding that
              foundation into full-stack development with Node.js, Express,
              SQL, and MongoDB.
            </p>
          </div>
