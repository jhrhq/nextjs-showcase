  ...
  return (
    <PopperPrimitive.Root {...popperScope}>
      <PopoverProvider
        ...
        /**
         * ---- CHANGES I DID -------
         * I changed this line onOpenToggle={React.useCallback(() => setOpen((prevOpen) => !prevOpen)[setOpen])}
         * to         onOpenToggle={React.useCallback(() => setOpen(() => true), [setOpen])} this line.
         * that means I removed previous open params and setOpen to true
         */
        onOpenToggle={React.useCallback(() => setOpen(() => true), [setOpen])}
...
interface PopoverTriggerProps extends PrimitiveInputProps {}
  ...
  (props: ScopedProps<PopoverTriggerProps>, forwardedRef) => {
    ...
    const trigger = (
      <Primitive.input
        ...
        /**
         * ---- CHANGES I DID -------
         * Added onFocus Instead onclick, The onFocus function has taken from radix-ui hover card onFocus event.
         * onClick is disabled,
         * I want to trigger the popover when user focuses or click on the input field or navigate with keyboard from one input field to another input field.
         */

        onFocus={composeEventHandlers<React.FocusEvent<HTMLInputElement, Element>>(context.onOpenToggle)}
