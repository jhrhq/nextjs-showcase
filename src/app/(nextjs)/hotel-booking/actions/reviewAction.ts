"use server";
import { auth } from "@/domains/hotel-booking/auth";
...
import {
  type PropertyReview,
  ReviewInputSchema,
} from "@/domains/hotel-booking/validationSchema/review-schema";
...
export async function createReviewAction({
  ...
  try {
    ...
    if (!review.success)
      return { status: false, errors: review.error.formErrors.fieldErrors };
