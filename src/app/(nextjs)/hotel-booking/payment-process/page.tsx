          ...
          <div>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <input type="text" placeholder="Expiration" className="p-3 border rounded-lg" />
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                ...
                <input type="text" placeholder="Apt or suite number" className="w-full p-3 border rounded-lg" />
          ...
          <div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm mb-8 sticky top-0">
              <div className="flex items-start gap-4 mb-6">
                ...
                />
                <div>
                  <p className="text-sm">One room and one living room with a straight sea view, 1.8m queen...</p>
