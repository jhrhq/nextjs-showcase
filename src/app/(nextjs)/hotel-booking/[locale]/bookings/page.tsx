    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white shadow-md rounded-lg p-4 flex items-center justify-between hover:shadow-lg transition-shadow">
            <div className="flex items-center space-x-4">
              ...
              />
              <div>
                <h2 className="text-lg text-zinc-800 font-semibold">Cozy Mountain Cabin</h2>
        ...
        <div id="empty-state" className="hidden text-center py-12">
          <Image src="./no-bookings-icon.svg" alt="No Bookings" className="mx-auto mb-4 w-32 h-32" />
