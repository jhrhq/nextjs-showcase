...
import { FaCircleCheck, FaDownload, FaEnvelope, FaMessage, FaStar, FaSuitcase } from "react-icons/fa6";
    ...
    <div className="max-w-3xl mx-auto p-6">
      ...
      <div className="text-center my-12">
        <div className="inline-block p-4 bg-green-100 rounded-full mb-6">
          <FaCircleCheck className="fas fa-check-circle text-4xl text-primary" />
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-4">
            <div className="text-primary">
              <FaMessage className="fas fa-comment-alt text-xl" />
            </div>
            <div>
          ...
          <div className="flex gap-4">
            <div className="text-primary">
              <FaSuitcase className="fas fa-suitcase text-xl" />
            </div>
            <div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        <Button className="px-6 py-3 bg-primary text-white rounded-lg hover:brightness-90">
          <FaDownload className="fas fa-download mr-2" />
          Download Receipt
        </Button>
      </div>
      {/* Need Help Section */}
      <div className="mt-12 text-center">
        ...
        <a href="#local" className="text-primary hover:underline">
